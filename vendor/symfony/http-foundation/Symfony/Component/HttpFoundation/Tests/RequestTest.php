...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // http://host:8080/About.php/path/info?query=string
        ...
        $server['REQUEST_URI'] = '/About.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/About.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/About.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/About.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/About.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/About.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/About.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide About.php)
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/About.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/About.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/About.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/About.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/About.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/About.php';
        $server['ORIG_SCRIPT_NAME'] = '/About.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
