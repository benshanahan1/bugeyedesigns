...
class Request
{
     ...
     *
     * Suppose that an About.php file instantiates this request object:
     *
     *  * http://localhost/About.php         returns an empty string
     *  * http://localhost/About.php/page    returns an empty string
     *  * http://localhost/web/About.php     returns '/web'
     *  * http://localhost/we%20b/About.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     *
     * @api
     ...
     * script filename (e.g. About.php) if one exists.
     *
